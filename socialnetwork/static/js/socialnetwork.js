        ...
        for ( i = start ; i < append_len ; i = i + 3){
            ...
            comment = items[i]["fields"]["comment"]
             $("#comments" + postid).append(
                "<div><img class='viewprofile' src= '/socialnetwork/photo/" + id +" '> " +
                "<a href='/socialnetwork/viewprofile/" + id+ " '> " + username +" </a> " +
                "<p1>Post Date:" + time +"</p1><br><br>"+
                 sanitize(comment)+          
                 "</div>")
         }
}
        ...
        for ( i = 0; i < append_len * 3; i = i + 3){
            ...
            // console.log(text)
             ...
             $("#showpost").prepend(
                ...
                "<img class='viewprofile' src= '/socialnetwork/photo/" + id +" '> " +
                "<a href='/socialnetwork/viewprofile/" + id+ " '> " + username +" </a> " +
                "<p1>Post Date:" + time +"</p1><br>"+
                ...
                "<div id='comments"+postid +"'></div>"+    
                 ...
                 "<button id = '"+ postid+ "' onclick='addComment( " + postid + ")' >AddCommnts</button>"+
